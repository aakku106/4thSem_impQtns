...
function getSubjectData(subject) {
    const subjects = {
        'AI': {
            ...
            code: 'CSC 303',
            description: 'Explore intelligent agents, search algorithms, knowledge representation, and machine learning.',
            ...
            emergency: [
                { title: 'FOPL Resolution Examples', path: 'AI/imp_qtns/2DayPrep/fopl_resolution_example.md' },
                { title: 'Informed Search Examples', path: 'AI/imp_qtns/2DayPrep/informed_search_examples.md' },
                { title: 'Short Question Cheatsheet', path: 'AI/imp_qtns/2DayPrep/short_qtn_cheatsheet.md' },
                { title: '2-Day Plan Overview', path: 'AI/imp_qtns/2DayPrep/README.md' }
            ],
            examples: [
                { title: 'G5 Solutions', path: 'AI/Example_soln/g5_soln.md' }
            ]
        },
        'CN': {
            name: 'Computer Networks',
            code: 'CSC 304',
            description: 'Master network protocols, architecture, and communication systems.',
            ...
            emergency: [
                { title: 'Distance Vector Routing', path: 'CN/imp_qtns/2DayPrep/distance_vector_routing.md' },
                { title: 'IPv4 vs IPv6 Explained', path: 'CN/imp_qtns/2DayPrep/ipv4_vs_ipv6_explained.md' },
                { title: 'TCP vs UDP', path: 'CN/imp_qtns/2DayPrep/tcp_vs_udp.md' },
                { title: 'Subnetting', path: 'CN/imp_qtns/2DayPrep/subnetting.md' },
                { title: 'Stop and Wait ARQ', path: 'CN/imp_qtns/2DayPrep/stop_and_wait_arq.md' },
                { title: 'Traffic Shaping', path: 'CN/imp_qtns/2DayPrep/traffic_shaping_explained.md' },
                { title: 'Switching & Topologies', path: 'CN/imp_qtns/2DayPrep/switching_and_topologies.md' },
                { title: 'MAC vs LLC', path: 'CN/imp_qtns/2DayPrep/mac_vs_llc.md' },
                { title: '2-Day Plan Overview', path: 'CN/imp_qtns/2DayPrep/README.md' }
            ]
        },
        'DBMS': {
            ...
            emergency: [
                { title: 'ACID Properties', path: 'DBMS/imp_qtns/2DayPrep/acid_properties.md' },
                { title: 'Normalization & FD', path: 'DBMS/imp_qtns/2DayPrep/normalization_and_fd.md' },
                { title: 'SQL Queries', path: 'DBMS/imp_qtns/2DayPrep/sql_queries.md' },
                { title: 'SQL Past Paper Solutions', path: 'DBMS/imp_qtns/2DayPrep/sql_past_paper_solutions.md' },
                { title: 'Three Schema Architecture', path: 'DBMS/imp_qtns/2DayPrep/three_schema_architecture.md' },
                { title: '2-Day Plan Overview', path: 'DBMS/imp_qtns/2DayPrep/README.md' }
            ]
        },
        'OS': {
            name: 'Operating System',
            code: 'CSC 306',
            description: 'Understand process management, memory management, and system calls.',
            ...
            emergency: [
                { title: 'CPU Scheduling Examples', path: 'OS/imp_qtns/2DayPrep/cpu_scheduling_examples.md' },
                { title: 'Deadlock Conditions', path: 'OS/imp_qtns/2DayPrep/deadlock_conditions.md' },
                { title: 'Disk Scheduling Examples', path: 'OS/imp_qtns/2DayPrep/disk_scheduling_examples.md' },
                { title: 'Mutual Exclusion & Race Condition', path: 'OS/imp_qtns/2DayPrep/mutual_exclusion_and_race_condition.md' },
                { title: 'Page Replacement Examples', path: 'OS/imp_qtns/2DayPrep/page_replacement_examples.md' },
                { title: 'Paging vs Segmentation', path: 'OS/imp_qtns/2DayPrep/paging_vs_segmentation.md' },
                { title: 'Process vs Thread', path: 'OS/imp_qtns/2DayPrep/process_vs_thread.md' },
                { title: '2-Day Plan Overview', path: 'OS/imp_qtns/2DayPrep/README.md' }
            ]
        },
        'TOC': {
            name: 'Theory of Computation',
            code: 'CSC 307',
            description: 'Study automata theory, formal languages, and computational complexity.',
            ...
            emergency: [
                { title: '2-Day TOC Survival Guide', path: 'TOC/imp_qtns/2DayPrep/2_Day_TOC_Survival_Guide.md' },
                { title: 'CFG Basics', path: 'TOC/imp_qtns/2DayPrep/cfg_basics.md' },
                { title: 'Chomsky Hierarchy Cheatsheet', path: 'TOC/imp_qtns/2DayPrep/chomsky_hierarchy_cheatsheet.md' },
                { title: 'Pumping Lemma Examples', path: 'TOC/imp_qtns/2DayPrep/pumping_lemma_examples.md' },
                { title: 'Thompson Construction', path: 'TOC/imp_qtns/2DayPrep/thompson_construction_examples.md' }
            ],
            examples: [
...
function generateModalContent(subject, data) {
    return `
        ...
        <div class="modal-section">
            <h3>Syllabus</h3>
            <button class="resource-link" onclick="viewContent('${data.syllabus}', 'Syllabus - ${data.name}')">
...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.subject-card, .feature-card, .emergency-card');
